package com.pkh.kotlin.kotlin_demo.config.aop
...
open class LoggingAspect() {
     ...
     */
    @Pointcut(
            "within(com.pkh.kotlin.kotlin_demo.repository..*)" +
                    " || within(com.pkh.kotlin.kotlin_demo.service..*)" +
                    " || within(com.pkh.kotlin.kotlin_demo.controller..*)"
    )
